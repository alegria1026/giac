...
export default function ServicesTable({ services, title }: { services: PaginatedServices; title: string }) {
                        ...
                        <table className="min-w-full text-sm text-left border-collapse">
                            ...
                            {filteredServices.map((s) => (
                                <tr
                                    ...
                                    onClick={() => router.visit('/services/' + s.id)}
                                >
                                    <td className="px-4 py-3 truncate max-w-xs">{s.name}</td>
